		...
		AFRAME.registerComponent('rounded', {
			...
			draw: function () {
				...
				function roundedRect(ctx, x, y, width, height, topLeftRadius, topRightRadius, bottomLeftRadius, bottomRightRadius) {
					...
					if (topLeftRadius) ctx.quadraticCurveTo(x, y + height, x + topLeftRadius, y + height);

					ctx.lineTo(x + width - topRightRadius, y + height);
					if (topRightRadius) ctx.quadraticCurveTo(x + width, y + height, x + width, y + height - topRightRadius);

					ctx.lineTo(x + width, y + bottomRightRadius);
					if (bottomRightRadius) ctx.quadraticCurveTo(x + width, y, x + width - bottomRightRadius, y);

					ctx.lineTo(x + bottomLeftRadius, y);
					if (bottomLeftRadius) ctx.quadraticCurveTo(x, y, x, y + bottomLeftRadius);
				}
